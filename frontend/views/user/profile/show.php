        ...
        <div class="card card-profile rounded">
            ...
            <div class="content">
                ...
                <ul style="padding: 0; list-style: none outside none;">
                    <?php if(\Yii::$app->authManager->getRolesByUser($profile->user_id)):?>
                    <li>
                        <i class="glyphicon glyphicon-user text-muted"></i> <span class="badge badge-pill badge-danger"><?= Html::encode(Helper::getUserRolesAsArray($profile->user_id)[0]) ?></span>                        
                    </li>
                    <?php endif;?>
