        ...
        <div class="col-md-6">
                <div class="card card-pricing card-raised">
                    <div class="card-content">
                        <h6 class="category">Conexiunea cu alte noduri <i class="material-icons text-rose">timeline</i></h6>
                        <span class="pull-right" data-toggle="tooltip" data-placement="right" title="Dacă sunt noduri pe care le cunoști si nu se află in sistemul acestei aplicații, te poți conecta introducând nodul lor, eg. 127.0.0.1:port.">
                            <a href="#">
