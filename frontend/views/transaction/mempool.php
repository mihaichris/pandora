            ...
            <div id ="mempool_profile" style="display: none;">
                <div class="card card-profile rounded">
                    ...
                    <div class ="card-avatar">
                        <img class = "avatar" id = "change-user_avatar" src=<?= file_exists(Yii::$app->basePath . "/web/img/". Yii::$app->user->identity->username ."_avatar.jpg") ? Yii::getAlias('@web') . "/frontend/web/img/". Yii::$app->user->identity->username ."_avatar.jpg" : Yii::getAlias('@web') . "/frontend/web/img/marc.jpg" ?>>
                    </div>
                    <div class="content">
                        <h5 id= "change-user_name"></h5>
                        <p class="description"><span id="change-user_role" class="badge badge-pill"></span></p>
                        <button id = "dismiss-mempool-details_button" type="button" class="btn btn-sm btn-simple btn-danger"><i class="material-icons">clear</i></button>
                    </div>
                    <div class="card-footer">
                        <div class="col-md-6 text-center">
                            <i class="material-icons">euro_symbol</i> <p id="change-user_amount"></p> 
                        </div>
                        <div class="col-md-6 text-center">
                            <i class="material-icons">date_range</i> <p id="change-user_created_at"></p> 
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-7">
            <div class="card">
                <div class="card-header"  data-background-color="orange">
                    <h4 class="card-title"> <i class="material-icons">hourglass_empty</i> Tranzacțiile tale în așteptare</h4>
                </div>
